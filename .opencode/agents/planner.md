...
template come from ANTfrastructure's shared Planner prompt, which the loop prepends
to this file automatically
(`third_party/ANTfrastructure/shared/agentic-loop/system-prompts/planner.md`).
